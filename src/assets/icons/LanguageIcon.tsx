...
const SvgComponent = (props: SVGProps<any>) => (
	<svg
		...
		{...props}
	>
		<path opacity={0.1} fill='url(#lang_a)' d='M0 0h80v80H0z' />
		<defs>
			<pattern id='lang_a' patternContentUnits='objectBoundingBox' width={1} height={1}>
				<use xlinkHref='#lang_b' transform='scale(.01042)' />
			</pattern>
			<image
				id='lang_b'
				width={96}
